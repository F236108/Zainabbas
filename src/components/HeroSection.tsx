    ...
    >
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center">
        ...
        >
          ...
          >
            <Button 
              className="bg-electric hover:bg-electric-dark text-black font-medium transition-all duration-300 transform hover:scale-105"
        ...
        >
          <div className="relative">
            <motion.div 
              ...
              transition={{ duration: 0.8, delay: 0.5 }}
              className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-electric/20 animate-glow"
            >
              <img 
